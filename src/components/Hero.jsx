...
function Hero({ scrollToSection }) {
  ...
  // Always call useTranslation - don't conditionally call hooks
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8 flex items-center justify-center bg-white/10 border-2 border-white/10 px-2 py-1 md:py-2 rounded-full"
        >
