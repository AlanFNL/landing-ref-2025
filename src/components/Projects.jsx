...
const ProjectCard = ({
  ...
  // Client: show animated project card
  return (
    <motion.div
      ref={cardRef}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {isServer ? (
          // Server: show static background for no-JS mode
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-0 -left-[30%] h-[120%] w-[160%] bg-gradient-to-r from-purple-900/20 via-purple-600/30 to-indigo-600/20 blur-[60px]" />
          </div>
        ) : (
          // Client: show animated background
          <motion.div
        ...
        {/* Top border line */}
        {isServer ? (
          // Server: show static border for no-JS mode
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500/40 to-transparent opacity-30" />
        ) : (
          // Client: show animated border
          <motion.div
        ...
        <div className="relative">
          ...
          {isServer ? (
            ...
            <div ref={titleRef} className="text-center mb-20 md:mb-24">
              ...
              <p className="mx-auto max-w-4xl text-xl md:text-2xl text-gray-300 leading-relaxed">
                {t(
            ...
            // Client: show animated title with scroll effects
            <motion.div
              ref={titleRef}
