      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        >
          ...
          >
            ...
            {/* VR Indicators */}
            <motion.div
              className="absolute top-1/4 left-1/4 w-16 h-16 rounded-full bg-purple-500/20 backdrop-blur-sm border border-purple-500/50 flex items-center justify-center"
              animate={{ scale: [1, 1.2, 1] }}
              transition={{ repeat: Infinity, duration: 3 }}
            >
              <span className="text-xs font-medium text-white">VR</span>
            </motion.div>

            <motion.div
              className="absolute bottom-1/3 right-1/4 w-20 h-20 rounded-full bg-blue-500/20 backdrop-blur-sm border border-blue-500/50 flex items-center justify-center"
              animate={{ scale: [1, 1.3, 1] }}
              transition={{ repeat: Infinity, duration: 4, delay: 1 }}
            >
              <span className="text-xs font-medium text-white">Metaverse</span>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
